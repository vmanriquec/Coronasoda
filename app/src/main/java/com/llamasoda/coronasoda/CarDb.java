...
public class CarDb extends RealmObject {
    ...
    public int getIdproductofuera() {
        return idproductofuera;
    }

    public void setIdproductofuera(int idproductofuera) {
        this.idproductofuera = idproductofuera;
    }

    private int idproductofuera;

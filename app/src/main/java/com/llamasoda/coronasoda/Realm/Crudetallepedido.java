...
public final static void  Disminuirdetalle ( Detallepedidorealm Detallepedidorealm){
    ...
    public  static void addDetallepedidorealm(final Detallepedidorealm Detallepedidorealm){
        Realm realm = Realm.getDefaultInstance();

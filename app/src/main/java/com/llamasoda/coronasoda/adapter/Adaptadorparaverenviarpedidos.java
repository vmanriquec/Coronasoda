...
import com.llamasoda.coronasoda.Enviarpedido;
...
public class Adaptadorparaverenviarpedidos extends RecyclerView.Adapter<Adaptadorparaverenviarpedidos.AdaptadorViewHolder> {
    ...
    public Adaptadorparaverenviarpedidos.AdaptadorViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v= LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.tarjetapedidoenviado,viewGroup,false);
    ...
    public void onBindViewHolder(final Adaptadorparaverenviarpedidos.AdaptadorViewHolder viewHolder, final int position) {
        ...
        viewHolder.precio.setText(String.valueOf(item.getPrecventarealm()));
        viewHolder.cremas.setText(String.valueOf(item.getIdpedido()));
        viewHolder.adicional.setText(String.valueOf(item.getImagenrealm()));
        viewHolder.subtotal.setText(String.valueOf(item.getSubtotal()));
        viewHolder.comentario.setText(String.valueOf(item.getComentarioacocina()));
        viewHolder.cantidad.setText(String.valueOf(item.getCantidadrealm()));
